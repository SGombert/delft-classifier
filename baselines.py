...
for mtd in ['ext', 'rf', 'dt', 'lr']:
    print('Classifier type: ' + mtd)
    for column in dataset.columns[1:]:
        ...
        for n in tqdm(range(5)):
            ...
            for train_index, val_index in kfold.split(X=values, y=labels):
                vectorizer = TfidfVectorizer(analyzer='char', ngram_range=(3,3), max_df=0.90, min_df=0.01, max_features=5000)
